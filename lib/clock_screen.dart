...
import 'package:clockapp/constants/constants.dart';
import 'package:clockapp/modules/clock_container.dart';
import 'package:clockapp/modules/current_time_clock_hands.dart';
import 'package:clockapp/modules/fancy_button.dart';
import 'package:clockapp/modules/top_row.dart';
import 'package:clockapp/modules/world_time_clock_hands.dart';
...
//    _getLocationFromSharedPref();
  ...
  void getWorldTime() async {
    ...
    date=(worldTimeString.substring(0,10));
    if (this.mounted) {
      setState(() {
